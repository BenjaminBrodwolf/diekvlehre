...
window.AddToHomeScreenInstance = new AddToHomeScreen(
  {
    appName: 'Die Kv-Lehre',                                   // Name of the app.
    // Required.
    appIconUrl: 'icon.png',                    // App icon link (square, at least 40 x 40 pixels).
    // Required.
    assetUrl: './img/a2hs/',  // Link to directory of library image assets.
    // Required.
